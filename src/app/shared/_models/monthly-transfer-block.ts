...
export enum Types {
  ...
  Study_fund_accepts_only_employee_and_employer_benefits = 'קרן השתלמות מקבלת רק הטבות עובד ומעביד',
  Study_fund_accept_only_employee_or_employer_benefits = 'בקרן השתלמות יש רק הטבת עובד או מעביד',
