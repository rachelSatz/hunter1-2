...
export class NeedToChargeEmployersComponent implements OnInit {
  ...
  readonly columns  = [
    ...
    { name: 'ids_count', label: 'כמות ת.ז', isDisplay: this.selectUnit.getProjectGroupId() === PROJECT_GROUP.SMARTI},
    { name: 'total_amount', label: 'סכום' , isDisplay: this.selectUnit.getProjectGroupId() === PROJECT_GROUP.SMARTI},
  ];
  dataFilters: {};
  smarti: boolean;
  constructor(private dialogRef: MatDialogRef<NeedToChargeEmployersComponent>,
    ...
    this.dataFilters = {};
    this.smarti = this.selectUnit.getProjectGroupId() === PROJECT_GROUP.SMARTI ? true : false;
  }
